...
class requeteListePartiesTests {
    /**
    ...
    @Test
    fun requeteListePartiesAucunePartie() {

        val partiesCreees = client.requeteListeParties()
    ...
    @Test
    fun requeteListePartiesUnePartie() {
    ...
    @Test
    fun requeteListePartiesPlusieursParties() {
